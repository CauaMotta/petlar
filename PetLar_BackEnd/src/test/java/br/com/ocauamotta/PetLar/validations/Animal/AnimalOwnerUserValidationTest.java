...
@Import(AnimalOwnerUserValidation.class)
class AnimalOwnerUserValidationTest {
    ...
    void testValidate_NotShouldThrowException() {
        assertDoesNotThrow(
                () -> animalOwnerUserValidation.validate(createAnimal("1"), createUser()));
    }
    ...
    void testValidate_ShouldThrowException() {
        assertThrows(UserWhoIsNotTheOwnerOfTheAnimalException.class,
                () -> animalOwnerUserValidation.validate(createAnimal("2"), createUser()));
    }
